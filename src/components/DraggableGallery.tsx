...
export default function DraggableGallery() {
  ...
  return (
    <section className="bg-[#3e2723] py-24 relative overflow-hidden" data-cursor="DRAG">
      <DraggableCardContainer className="relative flex min-h-[800px] w-full items-center justify-center overflow-clip">
        <p className="absolute top-1/2 mx-auto max-w-sm -translate-y-3/4 text-center text-2xl font-black text-neutral-300 md:text-4xl drop-shadow-xl z-0">
